Below is a drop-in upgraded Streamlit app with a “wow” UI, status indicators, and an interactive dashboard. It also adds the new features you requested:
...
<div class="wow-header">
  ...
  <span class="small">Streamlit • Gemini • OpenAI • Grok • OCR • Mind Graph • Dashboard</span>
</div>
""", unsafe_allow_html=True)
...
tab_home, tab_file, tab_datasets, tab_graph, tab_agents, tab_logs = st.tabs([
    "Dashboard", "File → Markdown + Summary", "Multi-Dataset Analysis", "Mind Graph", "Agents", "Logs"
])
